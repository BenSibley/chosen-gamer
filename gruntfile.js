module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        compress: {
            main: {
                options: {
                    archive: '/Users/bensibley/Desktop/chosen-gamer.zip'
                },
                files: [
                    {
        ...
        shell: {
            zip: {
                command: [
                    ...
                    'rm -R /Users/bensibley/Documents/compete-themes/dist/chosen-gamer || true',
                    'rm -R /Users/bensibley/Documents/compete-themes/dist/chosen-gamer.zip || true',
                    // copy folder without any project/meta files
                    'rsync -r /Applications/MAMP/htdocs/wordpress/wp-content/themes/chosen-gamer /Users/bensibley/Documents/compete-themes/dist/ <%= excludeFiles %>',
                    // open dist
                    'cd /Users/bensibley/Documents/compete-themes/dist/',
                    // zip the chosen-gamer folder
                    'zip -r chosen-gamer.zip chosen-gamer'
                ].join('&&')
            }
        }
    });
